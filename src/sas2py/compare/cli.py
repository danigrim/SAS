"""
Command-line interface for dataset comparison utilities.
"""
import argparse
import os
import sys
...
from .macros import compvars, complibs, compare
from ..core.readers import read_sas
