"""
Command-line interface for PhUSE box plot generation.
"""
import argparse
import os
import sys
...
from .boxplot import generate_phuse_boxplots
...
def generate_boxplots_cli():
    """
    Command-line interface for generating PhUSE-compliant box plots.
    """
